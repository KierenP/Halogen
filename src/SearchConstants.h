...
TUNEABLE_CONSTANT double LMR_constant = -0.35;
TUNEABLE_CONSTANT double LMR_depth_coeff = -1.02;
TUNEABLE_CONSTANT double LMR_move_coeff = 2.98;
TUNEABLE_CONSTANT double LMR_depth_move_coeff = 0.09;
