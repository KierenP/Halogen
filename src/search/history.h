...
{
    static TUNEABLE_CONSTANT int max_value = 5579;
...
{
    static TUNEABLE_CONSTANT int max_value = 8977;
...
{
    static TUNEABLE_CONSTANT int max_value = 15234;
...
{
    static TUNEABLE_CONSTANT int max_value = 8051;
...
struct PawnCorrHistory
{
    ...
    static TUNEABLE_CONSTANT int scale = 97;
...
struct NonPawnCorrHistory
{
    ...
    static TUNEABLE_CONSTANT int scale = 138;
...
struct PieceMoveCorrHistory
{
    ...
    static TUNEABLE_CONSTANT int scale = 128;
