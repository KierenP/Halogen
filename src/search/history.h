...
{
    static TUNEABLE_CONSTANT int max_value = 5334;
...
{
    static TUNEABLE_CONSTANT int max_value = 9215;
...
{
    static TUNEABLE_CONSTANT int max_value = 15726;
...
{
    static TUNEABLE_CONSTANT int max_value = 8809;
    static TUNEABLE_CONSTANT int scale = 37;
...
struct PawnCorrHistory
{
    ...
    static TUNEABLE_CONSTANT int correction_max = 68;
    static TUNEABLE_CONSTANT int scale = 94;
...
struct NonPawnCorrHistory
{
    ...
    static TUNEABLE_CONSTANT int scale = 141;
...
struct PieceMoveCorrHistory
{
    ...
    static TUNEABLE_CONSTANT int scale = 131;
