...
#else
    // Identity permutation placeholder - will be replaced with a network-specific shuffle order after training
    constexpr auto shuffle_order = []()
    {
        std::array<size_t, FT_SIZE / 2> order {};
