    ...
    const decltype(raw_network::ft_bias)& ft_bias, const decltype(raw_network::l1_weight)& l1_weight)
{
    ...
    *l1_weight_output = l1_weight;
    ...
    constexpr std::array<size_t, FT_SIZE / 2> shuffle_order  = { 
        33, 121, 105, 94, 40, 44, 135, 197, 246, 190, 96, 93, 147, 107, 10, 235, 72, 153, 109, 122, 208, 251, 123,
        180, 84, 133, 101, 136, 244, 43, 152, 179, 139, 63, 106, 143, 159, 15, 248, 217, 250, 173, 116, 199, 194,
        140, 238, 198, 55, 209, 232, 176, 236, 183, 5, 245, 201, 54, 64, 229, 17, 79, 249, 137, 160, 171, 42, 39,
        162, 98, 210, 62, 212, 185, 146, 219, 86, 207, 34, 78, 131, 80, 3, 58, 226, 61, 89, 12, 31, 220, 81, 91, 46,
        32, 47, 216, 38, 97, 108, 142, 29, 13, 19, 215, 191, 90, 18, 253, 132, 242, 125, 223, 213, 120, 77, 230, 41,
        112, 118, 1, 192, 51, 115, 113, 200, 49, 141, 88, 138, 71, 67, 114, 95, 158, 247, 16, 69, 184, 53, 165, 175,
        9, 170, 22, 126, 100, 224, 48, 110, 172, 130, 111, 75, 129, 28, 6, 73, 234, 150, 154, 128, 27, 205, 157, 45,
        65, 144, 23, 148, 169, 103, 20, 26, 50, 166, 25, 254, 186, 227, 163, 66, 117, 161, 145, 56, 127, 149, 2,
        252, 59, 211, 60, 76, 83, 102, 195, 189, 231, 21, 82, 188, 193, 85, 203, 206, 243, 11, 255, 155, 178, 92,
        68, 87, 57, 0, 196, 204, 104, 134, 24, 119, 4, 222, 214, 225, 30, 99, 228, 221, 167, 164, 174, 7, 177, 151,
        233, 124, 202, 8, 181, 218, 241, 168, 156, 37, 74, 237, 14, 36, 239, 187, 182, 240, 52, 35, 70,
    };
    // clang-format on
    ...
    for (size_t i = 0; i < FT_SIZE / 2; i++)
    {
        ...
        for (size_t j = 0; j < TOTAL_FT_INPUTS; j++)
        {
...
auto adjust_for_packus(const decltype(raw_network::ft_weight)& ft_weight, const decltype(raw_network::ft_bias)& ft_bias)
{
    ...
    for (size_t i = 0; i < TOTAL_FT_INPUTS; i++)
    {
