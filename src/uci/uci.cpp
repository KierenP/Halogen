...
#define tuneable_float(name, default_, min_, max_)                                                                     \
    ...
    return uci_options {
        ...
        tuneable_int(aspiration_width, 13, 5, 25),
        ...
        tuneable_int(se_double_margin, 11, -10, 30),
        tuneable_int(se_multi_extend, 8, 4, 12),
        tuneable_int(se_depth_limit, 6, 1, 12),
        tuneable_int(se_tt_depth, 2, 0, 6),
        tuneable_int(lmr_history, 3902, 2048, 8196),
        tuneable_int(snmp_margin, 104, 50, 150),
        tuneable_int(snmp_depth, 8, 2, 16),
        tuneable_int(iid_depth, 3, 0, 7),
        tuneable_int(lmp_constant, 4, 0, 11),
        tuneable_int(lmp_depth_coeff, 4, 1, 12),
        tuneable_int(lmp_depth_limit, 6, 1, 12),
        ...
        tuneable_float(LMR_constant, 1.14, -2, 3),
        tuneable_float(LMR_depth_coeff, -1.44, -5, 3),
        tuneable_float(LMR_move_coeff, 1.31, -2, 3),
        tuneable_float(LMR_depth_move_coeff, 0.37, -1, 2),
    };
